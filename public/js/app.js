async function loadProducts() {
  ...
  try {
    ...
    // 👇 Swiper Initialisierung mit Loop & Autoplay
    if (!swiperContainer.classList.contains('swiper-initialized')) {
      const swiper = new Swiper(swiperContainer, {
        ...
        loop: true,
        loopMode: 'flip', // Stabil bei dynamischen Inhalten
        autoplay: {
          delay: 3500,
        ...
        // ⚡ Wichtig für dynamisch geladene Inhalte
        observer: true,
        observeParents: true,
      ...
      // Layout nach DOM-Insertion neu berechnen
