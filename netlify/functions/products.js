...
export const handler = async (event, context) => {
  const method = event.request?.method || event.httpMethod;
  ...
  if (method === 'GET') {
    const products = [
      ...
      { id: 5, name: 'PurePreP', price: 29.99, image: 'https://images.unsplash.com/photo-1625842268584-8f3296236761?w=400&q=80' },
      { id: 6, name: 'Ersatz Röhrchen', price: 4.99, image: 'https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=400&q=80' }
    ];
